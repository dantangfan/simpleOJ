...
(function($) { "use strict";
  ...
  var Renderer = function() {
    var aToolbarItem = {
      ...
      link:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Link" data-event="showLinkDialog" data-shortcut="Ctrl+K" data-mac-shortcut="âŒ˜+K" tabindex="-1"><i class="fa fa-link"></i> </button>',
      table:
      ...
      color:
        ...
        '</ul>',
      bold:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Bold" data-shortcut="Ctrl+B" data-mac-shortcut="âŒ˜+B" data-event="bold" tabindex="-1"><i class="fa fa-bold"></i> </button>',
      italic:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Italic" data-shortcut="Ctrl+I" data-mac-shortcut="âŒ˜+I" data-event="italic" tabindex="-1"><i class="fa fa-italic"></i> </button>',
      underline:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Underline" data-shortcut="Ctrl+U" data-mac-shortcut="âŒ˜+U" data-event="underline" tabindex="-1"><i class="fa fa-underline"></i> </button>',
      clear:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Remove Font Style" data-shortcut="Ctrl+\\" data-mac-shortcut="âŒ˜+\\" data-event="removeFormat" tabindex="-1"><i class="fa fa-eraser"></i> </button>',
      ul:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Unordered list" data-shortcut="Ctrl+Shift+8" data-mac-shortcut="âŒ˜+â‡§+7" data-event="insertUnorderedList" tabindex="-1"><i class="fa fa-list-ul"></i> </button>',
      ol:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Ordered list" data-shortcut="Ctrl+Shift+7" data-mac-shortcut="âŒ˜+â‡§+8" data-event="insertOrderedList" tabindex="-1"><i class="fa fa-list-ol"></i> </button>',
      paragraph:
        ...
        '<ul class="dropdown-menu">' +
          ...
          '<button type="button" class="btn btn-default btn-sm btn-small" title="Align left" data-shortcut="Ctrl+Shift+L" data-mac-shortcut="âŒ˜+â‡§+L" data-event="justifyLeft" tabindex="-1"><i class="fa fa-align-left"></i> </button>' +
          '<button type="button" class="btn btn-default btn-sm btn-small" title="Align center" data-shortcut="Ctrl+Shift+E" data-mac-shortcut="âŒ˜+â‡§+E" data-event="justifyCenter" tabindex="-1"><i class="fa fa-align-center"></i> </button>' +
          '<button type="button" class="btn btn-default btn-sm btn-small" title="Align right" data-shortcut="Ctrl+Shift+R" data-mac-shortcut="âŒ˜+â‡§+R" data-event="justifyRight" tabindex="-1"><i class="fa fa-align-right"></i> </button>' +
          '<button type="button" class="btn btn-default btn-sm btn-small" title="Justify full" data-shortcut="Ctrl+Shift+J" data-mac-shortcut="âŒ˜+â‡§+J" data-event="justifyFull" tabindex="-1"><i class="fa fa-align-justify"></i> </button>' +
          '</div>' +
          '</li>' +
          '<li>' +
          '<div class="note-list btn-group">' +
          '<button type="button" class="btn btn-default btn-sm btn-small" title="Outdent" data-shortcut="Ctrl+[" data-mac-shortcut="âŒ˜+[" data-event="outdent" tabindex="-1"><i class="fa fa-dedent"></i> </button>' +
          '<button type="button" class="btn btn-default btn-sm btn-small" title="Indent" data-shortcut="Ctrl+]" data-mac-shortcut="âŒ˜+]" data-event="indent" tabindex="-1"><i class="fa fa-indent"></i> </button>' +
          '</li>' +
        '</ul>',
      height:
        ...
        '</ul>',
      help:
        '<button type="button" class="btn btn-default btn-sm btn-small" title="Help" data-shortcut="Ctrl+/" data-mac-shortcut="âŒ˜+/" data-event="showHelpDialog" tabindex="-1"><i class="fa fa-question"></i> </button>',
      fullscreen:
                     ...
                     '<div class="note-image-popover popover bottom in" style="display: none;">' +
                       ...
                       '<div class="popover-content note-image-content">' +
                         '<div class="btn-group">' +
                           ...
                           '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize Half" data-event="resize" data-value="0.5" tabindex="-1">Â½</button>' +
                           '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize Thrid" data-event="resize" data-value="0.33" tabindex="-1">â…“</button>' +
                           '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize Quarter" data-event="resize" data-value="0.25" tabindex="-1">Â¼</button>' +
                         '</div>' +
                         '<div class="btn-group">' +
    ...
    var sShortcutText = '<table class="note-shortcut">' +
                           ...
                           '</thead>' +
                           '<tbody>' +
                             '<tr><td>âŒ˜ + B</td><td>Toggle Bold</td></tr>' +
                             '<tr><td>âŒ˜ + I</td><td>Toggle Italic</td></tr>' +
                             '<tr><td>âŒ˜ + U</td><td>Toggle Underline</td></tr>' +
                             '<tr><td>âŒ˜ + â‡§ + S</td><td>Toggle Strike</td></tr>' +
                             '<tr><td>âŒ˜ + \\</td><td>Remove Font Style</td></tr>' +
                             '</tr>' +
                           '</tbody>' +
                         '</table>';
    ...
    var sShortcutAction = '<table class="note-shortcut">' +
                           ...
                           '</thead>' +
                           '<tbody>' +
                             '<tr><td>âŒ˜ + Z</td><td>Undo</td></tr>' +
                             '<tr><td>âŒ˜ + â‡§ + Z</td><td>Redo</td></tr>' +
                             '<tr><td>âŒ˜ + ]</td><td>Indent</td></tr>' +
                             '<tr><td>âŒ˜ + [</td><td>Outdent</td></tr>' +
                             '<tr><td>âŒ˜ + K</td><td>Insert Link</td></tr>' +
                             '<tr><td>âŒ˜ + ENTER</td><td>Insert Horizontal Rule</td></tr>' +
                           '</tbody>' +
                         '</table>';
    ...
    var sShortcutPara = '<table class="note-shortcut">' +
                          ...
                          '</thead>' +
                          '<tbody>' +
                            '<tr><td>âŒ˜ + â‡§ + L</td><td>Align Left</td></tr>' +
                            '<tr><td>âŒ˜ + â‡§ + E</td><td>Align Center</td></tr>' +
                            '<tr><td>âŒ˜ + â‡§ + R</td><td>Align Right</td></tr>' +
                            '<tr><td>âŒ˜ + â‡§ + J</td><td>Justify Full</td></tr>' +
                            '<tr><td>âŒ˜ + â‡§ + NUM7</td><td>Ordered List</td></tr>' +
                            '<tr><td>âŒ˜ + â‡§ + NUM8</td><td>Unordered List</td></tr>' +
                          '</tbody>' +
                        '</table>';
    ...
    var sShortcutStyle = '<table class="note-shortcut">' +
                           ...
                           '</thead>' +
                           '<tbody>' +
                             '<tr><td>âŒ˜ + NUM0</td><td>Normal Text</td></tr>' +
                             '<tr><td>âŒ˜ + NUM1</td><td>Heading 1</td></tr>' +
                             '<tr><td>âŒ˜ + NUM2</td><td>Heading 2</td></tr>' +
                             '<tr><td>âŒ˜ + NUM3</td><td>Heading 3</td></tr>' +
                             '<tr><td>âŒ˜ + NUM4</td><td>Heading 4</td></tr>' +
                             '<tr><td>âŒ˜ + NUM5</td><td>Heading 5</td></tr>' +
                             '<tr><td>âŒ˜ + NUM6</td><td>Heading 6</td></tr>' +
                           '</tbody>' +
                         '</table>';
                      ...
                      '<div class="modal-dialog">' +
                        '<div class="modal-content">' +
                          '<div class="modal-body">' +
                            ...
                            sShortcutTable +
                            '<p class="text-center"><a href="//hackerwins.github.io/summernote/" target="_blank">Summernote v0.3</a> Â· <a href="//github.com/HackerWins/summernote" target="_blank">Project</a> Â· <a href="//github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p>' +
                          '</div>' +
                        '</div>' +
                      '</div>' +
                    '</div>' +
