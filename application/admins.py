...
class MyProblemModelView(ModelView):
    #can_create = False
    can_delete = False
    column_list = ('id', 'owner_contest_id', 'owner_road_id', 'title', 'memory_limit', 'time_limit','description', 'input',
                   'output', 'sample_input', 'sample_output','hint', 'solution')
        ...
        if request.method == 'POST':
            try:
                ...
                if contest_id != 0:
                    ...
                    cont = models.Contest(request.form['title'],
                                          request.form['description'],
                                          request.form['start_time'],
                                          request.form['end_time'],
                                          request.form['problems'],
                                          request.form['private'],
                                          request.form['contestants'])
